...
function inicio() {
	...
	function menu() {
		...
		if (ban == 1) {
			cont.style.display = "grid"; // Muestra el contenedor
			let mensaje = "Tu puntaje: " + puntos;

			if (puntos > 2 && puntos < 4) {
				mensaje += "<br>¡Felicitaciones! Tu descuento es 3";
			} else if (puntos == 4) {
				mensaje += "<br>¡Felicitaciones! Tu descuento es 4";
			} else if (puntos >= 5) {
				mensaje += "<br>¡Felicitaciones! Tu descuento es 5";
			}
